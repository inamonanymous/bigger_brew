document.addEventListener('DOMContentLoaded', () => {
    ...
    const video = document.getElementById('video-checkout');
...
function handleQRCodeToCheckout(qrData) {
    fetch('/api/add-attendance-checkout', {
        method: 'POST',
        headers: {
    ...
    .catch(error => {
        ...
        Swal.fire({
            ...
            text: 'Failed to send QR code to the server.',
            timer: 1500,
            showConfirmButton: false
        });
    });
